...
const GrenadeComponent: React.FC<GrenadeComponentProps> = ({ percent, updatePercent }) => {
    const radius = 50;
    ...
    return (
        <div className="flex flex-row items-center justify-center absolute  bottom-[300px] z-40 -left-[120px] m-auto  w-full" onClick={handleClick}>
            <svg
                className="absolute"
                width="66"
                height="66"
